...
const slideCloseMenu = document.querySelector('#slide-close-menu')

mobileMenu.addEventListener('click', () => {
    slideMenu.style.left = '0px'
})

slideCloseMenu.addEventListener('click', () => {
    slideMenu.style.left = '-100%'
})



// Mobile Choice Carser
const mobileChoiceCarser = document.querySelectorAll('#mobile-choice-curser')
for (let i = 0; i < mobileChoiceCarser.length; i++) {
    mobileChoiceCarser[i].addEventListener('click', () => {
        slideMenu.style.left = '-100%'
    })
}
